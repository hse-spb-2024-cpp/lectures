...
//   a) Also: ADL (argument-dependent lookup)
//   b) Also: template argument deduction (unless removed via SFINAE)
// 2. Overload resolution. Output: a single overload.
//   a) Choosing "viable" functions: can theoretically be called (number of arguments match, there are conversions)
//   b) Choosing "best viable" function
//   Extra out-of-scope details at https://en.cppreference.com/w/cpp/language/overload_resolution
// 3. Access check.
